...
export class RoleServiceProxy {
    ...
    getFactory(): Observable<FactoryDto> {
        let url_ = this.baseUrl + "/api/services/app/Role/GetFactory";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetFactory(response: HttpResponseBase): Observable<FactoryDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getFactorys(): Observable<FactoryDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Role/GetFactorys";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetFactorys(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetFactorys(<any>response_);
                } catch (e) {
                    return <Observable<FactoryDto[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetFactorys(response: HttpResponseBase): Observable<FactoryDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                ...
                for (let item of resultData200)
                    result200.push(FactoryDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status === 401) {
...
export class FactoryDto implements IFactoryDto {
    ...
    factoryDiscription: string | undefined;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.factoryDiscription = data["factoryDiscription"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["factoryDiscription"] = this.factoryDiscription;
        return data; 
    }
